    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 11, padding: "4px 8px 18px" }}>
        <div style={{
          ...
          background: "var(--sage-500)", display: "flex", alignItems: "center",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        <NavItem href="/schedule" icon={CalendarIcon} label="月排班" />
        {!isAdmin && (
          <NavItem href="/preference" icon={HeartIcon} label="劃假月曆" />
        )}
      </div>
      ...
      <div style={{
        ...
        <div style={{
          width: 34, height: 34, borderRadius: "50%", background: "var(--sage-600)",
...
function UsersIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 20c0-3.3-2.1-6-5-6.5" />
    </svg>
  );
}
